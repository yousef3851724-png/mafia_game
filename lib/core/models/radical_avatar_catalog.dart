...
/// یک آواتار ثابت در کاتالوگ اصلی رادیکال.
/// فایل‌های واقعی تصویر باید در همین مسیرها قرار بگیرند.
...
class RadicalAvatarCatalog {
  static const List<RadicalAvatarAsset> avatars = [
    RadicalAvatarAsset(id: 'a01', assetPath: 'assets/avatars/avatar_01.png', displayNameFa: 'سیمرغ'),
    ...
    RadicalAvatarAsset(id: 'a04', assetPath: 'assets/avatars/avatar_04.png', displayNameFa: 'دیو سپید', isPremium: true),
    RadicalAvatarAsset(id: 'a05', assetPath: 'assets/avatars/avatar_05.png', displayNameFa: 'کاوه آهنگر'),
    RadicalAvatarAsset(id: 'a06', assetPath: 'assets/avatars/avatar_06.png', displayNameFa: 'ضحاک', isPremium: true),
  ];
