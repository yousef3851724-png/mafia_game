...
class LobbyPlayerLabel { final String playerId; final String playerName; final String? avatarAsset; final bool isLeader; final bool isStaff; final int rating; const LobbyPlayerLabel({required this.playerId, required this.playerName, this.avatarAsset, this.isLeader = false, this.isStaff = false, this.rating = 0}); }
class LobbyMessage {
...
class LobbyDefinition { final String id; final String name; final LobbyCategory category; final LobbyLabel label; final String ownerId; final bool locked; final bool staffOnly; final List<LobbyPlayerLabel> players; const LobbyDefinition({required this.id, required this.name, required this.category, required this.label, required this.ownerId, this.locked = false, this.staffOnly = false, this.players = const []}); }
