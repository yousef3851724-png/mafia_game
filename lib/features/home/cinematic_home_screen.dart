              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: const [Spacer(), _DiamondBadge()],
                    ),
                  ),
                  Expanded(
                    child: ListView(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 3),
              Text(label, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: selected ? RadicalTheme.goldBright : RadicalTheme.smoke)),
            ],
          ),
        ),
      ),
