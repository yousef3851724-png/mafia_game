  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'کلاس‌های نبرد مافیا',
          style: TextStyle(color: RadicalColors.goldAccent, fontWeight: FontWeight.bold),
        ),
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new, color: RadicalColors.goldAccent),
                  ...
                  children: [
                    _buildCard(
                      ...
                      () => Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => const LobbyHubScreen()),
                      ),
                    ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: RadicalColors.surfaceDark,
          borderRadius: BorderRadius.circular(16),
